  ...
  return (
    <footer className="w-full bg-gray-800 border-t border-gray-700 mt-auto">
      <div className="container mx-auto px-3 py-2 sm:px-4 sm:py-3">
        {/* Top Section - GitHub and Feedback */}
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          ...
          <button
            ...
            className="bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-2 py-1 sm:px-4 sm:py-2 rounded-lg shadow-lg flex items-center gap-1.5 transition-all duration-300 hover:scale-105 active:scale-95 group"
            aria-label="Give Feedback"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:rotate-12 transition-transform duration-300"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
